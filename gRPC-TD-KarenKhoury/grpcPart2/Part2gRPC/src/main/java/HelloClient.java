package LabGRPC; // ou MyLab1 selon ton proto

import io.grpc.ManagedChannel;
import io.grpc.ManagedChannelBuilder;
import LabGRPC.HelloRequest;
import LabGRPC.HelloResponse;
import LabGRPC.HelloServiceGrpc;

/**
 * 'HelloClient' class starts a gRPC client that calls the gRPC server for the HelloService.
...
public class HelloClient {
    ...
    public static void main(String[] args) {
        ...
        String greeting = "Bonjour depuis le client 👋";
