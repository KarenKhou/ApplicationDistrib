...
public class HelloServer {
    ...
    public HelloServer(int port) {
        this.port = port;
        this.server = ServerBuilder.forPort(port).addService(new HelloServiceImpl()).build();
    }
    ...
    public static void main(String[] args) throws Exception {
        int port = Integer.parseInt("50551");
     ...
     * This method handles the SayHello RPC method and responds with a greeting message.
     */
